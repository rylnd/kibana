...
export const detectionsMetricsSchema: MakeSchemaFrom<DetectionMetrics> = {
  detection_rules: {
  ...
  ml_jobs: {
    ...
    ml_job_metrics: {
      ...
      items: {
        ...
        // @ts-expect-error TS2232 this object does not include all properties
        // within <Partial<MlDataCounts>>, but MakeSchemaFrom requires them
        data_counts: {
          bucket_count: {
            type: 'long',
        ...
        // @ts-expect-error TS2232 this object does not include all properties
        // within <Partial<MlModelSizeStats>>, but MakeSchemaFrom requires them
        model_size_stats: {
        ...
        // @ts-expect-error TS2232 this object does not include all properties
        // within <Partial<MlJobTimingStats>>, but MakeSchemaFrom requires them
        timing_stats: {
          bucket_count: {
            type: 'long',
            _meta: { description: 'The number of buckets processed' },
        ...
        datafeed: {
          ...
          // @ts-expect-error TS2232 this object does not include all properties
          // within <Partial<MlDatafeedTimingStats>>, but MakeSchemaFrom requires them
          timing_stats: {
